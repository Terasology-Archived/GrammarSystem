...
public class DivideRuleTest {
    ...
    private final Vector3i posDim = new Vector3i(2, 7, 3);
    private final Vector3i negYDim = new Vector3i(2, -7, 3);
    private final Vector3i negZDim = new Vector3i(2, 7, -3);
    private final Vector3i relDim = new Vector3i(5, 1, 1);

    private DivideRule verticalDivPositiveY;
    private DivideRule verticalDivNegativeY;
    private DivideRule horizontalDivZ;
    private DivideRule horizontalDivNegZ;
    private DivideRule relDivide;
    private Shape succ1;
    private Shape succ2;
    private Shape relSucc1;
    private Shape relSucc2;
    private Shape relSucc3;
